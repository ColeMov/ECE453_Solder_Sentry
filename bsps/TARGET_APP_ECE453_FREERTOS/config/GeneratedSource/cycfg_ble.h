...
#define CY_BLE_CFG_TOOL_VERSION              (330)
...
#define CY_BLE_BONDING_REQUIREMENT                  (0x01u)
...
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x000Cu)
...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x08u)

/** The size of the cy_ble_attValuesLen array */
#define CY_BLE_GATT_DB_ATT_VAL_LEN_COUNT            (0x08u)

/** GATT Role */
#define CY_BLE_GATT_ROLE                            (0x01u)
#define CY_BLE_GATT_DB_CCCD_COUNT                   (0x02u)
#define CY_BLE_ATT_UUID_128_COUNT                   (0x03u)
...
#define CY_BLE_CONFIG_MAX_BONDED_DEVICES            (0x10u)                                     
/** Max Tx payload size */
...
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_COUNT               (0x02u)

/** The size of the cy_ble_customSDesc array */
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_DESCRIPTORS_COUNT   (0x01u)
 ...
 */
#define CY_BLE_CUSTOM_SERVICE_SERVICE_INDEX   (0x00u) /* Index of Custom Service service in the cy_ble_customSServ array */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_2_CHAR_INDEX   (0x01u) /* Index of Custom Characteristic 2 characteristic */

#define CY_BLE_CUSTOM_SERVICE_SERVICE_HANDLE   (0x0007u) /* Handle of Custom Service service */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0008u) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0009u) /* Handle of Custom Characteristic characteristic */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Au) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_2_DECL_HANDLE   (0x000Bu) /* Handle of Custom Characteristic 2 characteristic declaration */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_2_CHAR_HANDLE   (0x000Cu) /* Handle of Custom Characteristic 2 characteristic */
